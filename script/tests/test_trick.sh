...
f_rubyfmt 01-kinaba/entry.rb > ./kinaba_out.rb
ruby ./kinaba_out.rb
f_rubyfmt ./kinaba_out.rb > ./kinaba_out_2.rb
ruby ./kinaba_out_2.rb

echo "def sleep(n); end;" | cat - 02-mame/entry.rb  > 02-mame/fast_entry.rb

f_rubyfmt 02-mame/fast_entry.rb > ./mame_out.rb
...
then
    ...
    f_rubyfmt entry.rb > entry_formatted.rb
