.PHONY: docker-test
SRCS=src/requires.rb src/line_metadata.rb src/line_tokens.rb src/token_collection.rb src/line.rb src/parser_state.rb src/parser.rb src/format.rb src/main.rb
